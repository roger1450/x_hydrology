...
def data_loading(data_dir,file_variables):#
    ...
    for file in file_variables:
        ...
        nc_file.close()
    return output
def train(vars,target_idx,time_lag,time_dim,lat_dim,lon_dim,mask='no',time_lead=3,target_hist=False,para_path='para_path',save=True):
    """**Description:** this method is used to load the required climate variables
            ...
            input_fea_num: bool,default=False
